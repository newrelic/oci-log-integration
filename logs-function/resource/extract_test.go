...
// entity-definitions rule for either)). Records are the CloudEvent directly, matching what
// Service Connector Hub actually delivers -- no logContent/datetime wrapper.
